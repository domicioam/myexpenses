...
import com.dgsystems.myexpenses.app.dummy.DummyContent.DummyItem;
...
public class MyExpenseRecyclerViewAdapter extends RecyclerView.Adapter<MyExpenseRecyclerViewAdapter.ViewHolder> {
    ...
    public MyExpenseRecyclerViewAdapter(List<DummyItem> items) {
        mValues = items;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.fragment_expenses, parent, false);
